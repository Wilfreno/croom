        ...
        <Body className="bg-white">
          ...
          >
            ...
            <Section className="text-slate-800">
              ...
              <Text>
                Welcome to <strong>Croom!</strong> Use the verification code below to proceed your sign up process:
              </Text>
            </Section>
            <Section className="my-[8dvh] mx-auto ">
              <Text className="font-bold text-5xl text-violet-900 uppercase text-center tracking-[2.5vw]">
                {code ? code : 'verify'}
              </Text>
            </Section>
            ...
            <Section>
              <Text className="text-xs text-slate-500 text-justify">
                ...
                <Link href="https://www.chat-up.xyz/">{'(https://www.chat-up.xyz/)'}</Link>. if you did not expect an
                email from us reset your password, further secure your email address and email us on{' '}
                <strong>croom.dev@gmail.com</strong> so we can delete your information in our system.
              </Text>
            </Section>
          </Container>
        </Body>
