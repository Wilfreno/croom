...
import { Image as ImageIcon, ImagePlus, UserRound } from "lucide-react";
    ...
    <section className="h-full w-full grid grid-rows-[1fr_auto]">
      <div className="h-full w-full">
        {!!found_messages?.pages.length && !isError && (
          <ScrollArea className="h-[80dvh] grid content-end">
              ...
              {found_messages.pages.map((page) =>
                page.result.map((message, index) => (
                  ...
                  >
                    ...
                    <div className="bg-primary max-w-[25vw] rounded-lg text-sm text-white overflow-hidden">
